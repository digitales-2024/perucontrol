...
namespace PeruControl.Migrations
{
    ...
    [Migration("20250622191729_ClientMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeruControl.Domain.Entities.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("_clientNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("ClientNumber");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("_clientNumber"));

                    b.HasKey("Id");

                    b.ToTable("DomainClients", (string)null);
                });

            modelBuilder.Entity("PeruControl.Domain.Entities.ClientLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("DomainClientLocations", (string)null);
                });
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Business", b =>
                {
                    ...
                    b.Property<string>("ResponsibleCIP")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ThechnicalDirectorCIP")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ThechnicalDirectorName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("ThechnicalDirectorPosition")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.ProjectAppointment", b =>
                {
                    ...
                    b.Property<Guid>("Report1Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Report2Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Report3Id")
                        .HasColumnType("uuid");

                    b.Property<Guid>("Report4Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Report1Id");

                    b.HasIndex("Report2Id");

                    b.HasIndex("Report3Id");

                    b.HasIndex("Report4Id");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Reports.CompleteReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CompleteReports");
                });

            modelBuilder.Entity("PeruControl.Infrastructure.Model.Reports.Report1", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Reports.Report2", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Reports.Report3", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Reports.Report4", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.TreatmentProduct", b =>
                {
                    ...
                    b.Property<Guid>("ProductAmountSolventId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductAmountSolventId");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Whatsapp.WhatsappTemp", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Domain.Entities.Client", b =>
                {
                    b.OwnsOne("PeruControl.Domain.ValueObjects.Address", "FiscalAddress", b1 =>
                        {
                            ...
                            b1.ToTable("DomainClients");

                            b1.WithOwner()
                                .HasForeignKey("ClientId");
                        });

                    b.OwnsOne("PeruControl.Domain.ValueObjects.DocumentInfo", "DocumentInfo", b1 =>
                        {
                            b1.Property<Guid>("ClientId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("PeruControl.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                            b1.Property<Guid>("ClientId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("PeruControl.Domain.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<Guid>("ClientId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Domain.Entities.ClientLocation", b =>
                {
                    b.HasOne("PeruControl.Domain.Entities.Client", null)
                        .WithMany("Locations")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("PeruControl.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                            b1.Property<Guid>("ClientLocationId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("ClientLocationId");

                            b1.ToTable("DomainClientLocations");
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Project", b =>
                {
                    b.HasOne("PeruControl.Domain.Entities.Client", "Client")
                        .WithMany()
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.ProjectAppointment", b =>
                {
                    b.HasOne("PeruControl.Infrastructure.Model.Reports.CompleteReport", "CompleteReport")
                        .WithMany()
                    ...
                    b.HasOne("PeruControl.Infrastructure.Model.Reports.Report1", "Report1")
                        .WithMany()
                        .HasForeignKey("Report1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeruControl.Infrastructure.Model.Reports.Report2", "Report2")
                        .WithMany()
                        .HasForeignKey("Report2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeruControl.Infrastructure.Model.Reports.Report3", "Report3")
                        .WithMany()
                        .HasForeignKey("Report3Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeruControl.Infrastructure.Model.Reports.Report4", "Report4")
                        .WithMany()
                        .HasForeignKey("Report4Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompleteReport");

                    b.Navigation("Project");

                    b.Navigation("Report1");

                    b.Navigation("Report2");

                    b.Navigation("Report3");

                    b.Navigation("Report4");
                });
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.TreatmentProduct", b =>
                {
                    b.HasOne("PeruControl.Infrastructure.Model.ProductAmountSolvent", "ProductAmountSolvent")
                        .WithMany()
                        .HasForeignKey("ProductAmountSolventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ProductAmountSolvent");
