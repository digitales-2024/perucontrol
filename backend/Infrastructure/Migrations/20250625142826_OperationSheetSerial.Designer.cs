...
namespace PeruControl.Migrations
{
    ...
    [Migration("20250625142826_OperationSheetSerial")]
    partial class OperationSheetSerial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.ProjectOperationSheet", b =>
                {
                    ...
                    b.Property<int>("OperationSheetNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("OperationSheetNumber"));
            ...
            modelBuilder.Entity("PeruControl.Infrastructure.Model.Supplier", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("SupplierNumber"));

                    b.HasKey("Id");

                    b.HasIndex("RucNumber")
                        .IsUnique();
