...
public class BusinessPatchDTO : IEntityPatcher<Business>
{
    ...
    {
        if (DigesaNumber != null) { entity.DigesaNumber = DigesaNumber; }
        if (Address != null) { entity.Address = Address; }
        if (Email != null) { entity.Email = Email; }
        if (RUC != null) { entity.RUC = RUC; }
        if (Phones != null) { entity.Phones = Phones; }
        if (DirectorName != null) { entity.DirectorName = DirectorName; }
        if (BankName != null) { entity.BankName = BankName; }
        if (BankAccount != null) { entity.BankAccount = BankAccount; }
        if (BankCCI != null) { entity.BankCCI = BankCCI; }
        if (Deductions != null) { entity.Deductions = Deductions; }
    }
}
