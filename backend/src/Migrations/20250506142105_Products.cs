    ...
    public partial class Products : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AmountAndSolvent = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductAmountSolvents", x => x.Id);
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable(name: "ProductAmountSolvents");
