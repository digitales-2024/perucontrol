...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PeruControl.Model.Reports.CompleteReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Model.Reports.Report1", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Model.Reports.Report2", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Model.Reports.Report3", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Model.Reports.Report4", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Model.Whatsapp.WhatsappTemp", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PeruControl.Model.ProjectAppointment", b =>
                {
                    ...
                    b.HasOne("PeruControl.Model.Reports.Report1", "Report1")
                        .WithMany()
                        .HasForeignKey("Report1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeruControl.Model.Reports.Report2", "Report2")
                        .WithMany()
                        .HasForeignKey("Report2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeruControl.Model.Reports.Report3", "Report3")
                        .WithMany()
                        .HasForeignKey("Report3Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PeruControl.Model.Reports.Report4", "Report4")
                        .WithMany()
            ...
            modelBuilder.Entity("PeruControl.Model.TreatmentProduct", b =>
                {
                    b.HasOne("PeruControl.Model.ProductAmountSolvent", "ProductAmountSolvent")
                        .WithMany()
