...
export function ExportCSVDialog({ trigger }: ExportCSVDialogProps)
{
    ...
    const handleExport = async() =>
    {
        ...
        await toastWrapper(
            (async() =>
            {
                const [blob, error] = await ExportClientsCSV(
                    startDate || undefined,
                    endDate || undefined,
                );
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        Si no especificas fechas, se exportarán todos los clientes.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                        <p className="text-sm text-blue-700">
                            ...
                            {" "}
                            Si no especificas una fecha de inicio, se exportarán todos los clientes desde el primer registro.
