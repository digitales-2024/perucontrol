...
export interface paths {
    ...
    "/api/Appointment/{appointmentId}/SheetProductNames": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": Array<components["schemas"]["ProductSimpleDTO"]>;
                        "application/json": Array<components["schemas"]["ProductSimpleDTO"]>;
                        "text/json": Array<components["schemas"]["ProductSimpleDTO"]>;
                    };
                };
            };
        };
