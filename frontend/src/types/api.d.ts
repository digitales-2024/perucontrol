        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": Array<components["schemas"]["GetCertificateForTableOutDto"]>;
                        "application/json": Array<components["schemas"]["GetCertificateForTableOutDto"]>;
                        "text/json": Array<components["schemas"]["GetCertificateForTableOutDto"]>;
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": Array<components["schemas"]["GetCertificateForCreationOutDto"]>;
                        "application/json": Array<components["schemas"]["GetCertificateForCreationOutDto"]>;
                        "text/json": Array<components["schemas"]["GetCertificateForCreationOutDto"]>;
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": Array<components["schemas"]["LegacyClient"]>;
                        "application/json": Array<components["schemas"]["LegacyClient"]>;
                        "text/json": Array<components["schemas"]["LegacyClient"]>;
                    };
                };
            };
        };
...
export interface components {
    schemas: {
        ...
        Client: {
            /** Format: int32 */
            clientNumber?: number;
            documentInfo?: components["schemas"]["DocumentInfo"];
            razonSocial?: string | null;
            businessType?: string | null;
            name?: string;
            fiscalAddress?: components["schemas"]["Address"];
            email?: components["schemas"]["Email"];
            phoneNumber?: components["schemas"]["PhoneNumber"];
            contactName?: string | null;
            locations?: Array<components["schemas"]["ClientLocation"]> | null;
            /** Format: uuid */
            id?: string;
            isActive?: boolean;
            /** Format: date-time */
        ...
        GetCertificateForCreationOutDto: {
            ...
            availableCerts: Array<components["schemas"]["CertificateAvailable"]>;
        };
        ...
        LegacyClient: {
            ...
            phoneNumber: string;
            contactName?: string | null;
            clientLocations: Array<components["schemas"]["LegacyClientLocation"]>;
            /** Format: date-time */
            createdAt?: string;
            /** Format: date-time */
            modifiedAt?: string;
